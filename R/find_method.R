...
find_method <- function(ranking = "both",
  ...
  tr$score[tr$ecosystem_servics == inp$ecosystem_servics] <- tr$score[tr$ecosystem_servics == inp$ecosystem_servics] + (inp$ecosystem_servics * wei["ecosystem_services"])
  ...
  tr$score_strict[tr$ecosystem_servics == inp$ecosystem_servics] <- tr$score_strict[tr$ecosystem_servics == inp$ecosystem_servics] + (1 * wei["ecosystem_servics"])
